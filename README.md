...
4) if used MinGW in highlight.h must be used #include "mingw.thread.h" instead of #include <thread>
5) possible issue with MinGW: wrong _WIN32_WINNT, should be redefined in cppImp_highlightIDE.cpp (#define _WIN32_WINNT 0x0A00)